...
use crate::api::recipe_api::{delete_recipe_by_id, get_all_recipes_pagination, get_recipe_by_id, get_recipe_img_url_by_id, get_recipes_by_email, insert_recipe, update_image_url_by_recipe_id, update_recipe_by_id};
...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .service(update_image_url_by_recipe_id)
